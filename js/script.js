// Detectar parámetro en la URL
   ...
   // Script para que el boton cambie el idioma del párrafo -->
    ...
    // Muestra solo el panel correspondiente
       ...
       //botones para a,pliar y reducir el panel donde se encuentra la información y animación      

        const btnExpand = document.getElementById("btnExpandPanel");
        const btnClose = document.getElementById("btnCloseExpand");
        const panel = document.getElementById("elefante");

            if (btnExpand && btnClose && panel) {
                btnExpand.addEventListener("click", () => {
                if (panel.requestFullscreen) {
                    panel.requestFullscreen(); // Activa el modo pantalla completa
             }     else if (panel.webkitRequestFullscreen) { 
                    panel.webkitRequestFullscreen(); // Para Safari
                    } else if (panel.msRequestFullscreen) { 
                        panel.msRequestFullscreen(); // Para Edge
            }
